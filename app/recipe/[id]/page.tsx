    ...
    return (
        <ScrollArea className="p-6 h-full bg-white rounded-lg shadow-md">
            <div className="max-w-3xl mx-auto">
                <h1 className="text-3xl font-extrabold text-gray-800 mb-6">{recipe.title}</h1>
                <img
                    src={recipe.image}
                    alt={recipe.title}
                    className="mb-6 w-full max-w-md rounded-lg shadow-lg mx-auto"
                />
                <p className="text-base leading-relaxed text-gray-700" dangerouslySetInnerHTML={{ __html: sanitizedSummary }}></p>
                <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Instructions</h3>
